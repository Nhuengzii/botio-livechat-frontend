<template>
  <div class="flex-[1] flex flex-col justify-between bg-[#EEEEEE]  min-w-[320px] max-w-[350px] ml-1 rounded-[10px]">
    <div>
    ...
    <div v-if="conversationsThreadMode == 'normal'"
      class="flex w-full items-center  justify-center bg-[#27374D] h-[370px] rounded-b-[10px] text-[#FFD95A] text-[16px]">
      Botio X CPE
    </div>
  </div>
</template>

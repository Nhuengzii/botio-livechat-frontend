<template>
    <aside class="flex-row justify-center w-[25%] h-[25%] bg-green-400 rounded-t-[18px] mb-1 p-1 duration-500 border-solid border-glass relative    shadow-inner">
        <div v-if="$route.params.platform === 'facebook'" class="w-full h-full overflow-clip">

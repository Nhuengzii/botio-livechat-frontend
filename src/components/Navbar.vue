        ...
        <div :class="[isExpand ? 'w-20 bg-[#394867] duration-300' : 'w-52 bg-[#EAEAEA] duration-300']"   >
            ...
            <div :class="[isExpand?  '':'bg-white']" class="m-2 ">
                <div v-show="!isExpand" class="flex p-3    duration-300" >
                    ...
                    <div class="  ml-2">
                        <button class=" items-center px-3 py-1  duration-300  rounded-md  bg-[#394867] text-white  hover:scale-105">NamePage</button>
                        <button class="items-center px-3 py-1  duration-300  rounded-md bg-[#00ABB3] mt-2 hover:scale-105">change</button>
                    </div>
                </div>
                <div  :class="[isExpand? 'justify-center':'justify-end py-2 mx-2 ']" class=" flex  " >
                    <button    @click="isExpand=!isExpand" :class="[isExpand? 'justify-center':'justify-end bg-[#394867]']" class="flex  space-x-2  w-full px-3 py-2  duration-300  rounded-md  hover:bg-gray-500  " >
                        <svg   :class="[isExpand? 'fill-blue-500  hover:rotate-[360deg] hover:scale-125':'fill-white rotate-[180deg] hover:rotate-[540deg] hover:scale-125']"  class=" duration-300"  xmlns="http://www.w3.org/2000/svg" height="1.5rem" fill="currentColor" viewBox="0 0 512 512"> 
                            <path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z"/>
                        </svg>
                    </button>
                </div>
                <div v-show="isExpand" class="flex  justify-center mt-4">
                    <img class="rounded-full w-12 h-12   hover:rotate-[360deg] hover:scale-125 duration-300" src="../assets/profoetest.jpg" />
                </div>
            </div>
            <!--Menu-->
            <div class="m-2 justify-center duration-300 " :class="isExpand? 'mt-20':'mt-10 ' " > 
                <router-link to="/Start" class="relative  ">
                    <button @click="{ show_Chat = false ; updateActiveTap('start') }" 
                        ...
                        class="flex justify-center hover:bg-[#00ABB3] text-white w-full  py-3    ">
                            ...
                            :style="{ color: active == 'start' as string? activeOpenColor:activecCloseColor }"  
                            ...
                            :style="{ color: active == 'start' as string? activecCloseColor:activeOpenColor }" 
                                class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                                    d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12.435 12.435 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A19.626 19.626 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a19.587 19.587 0 0 0 1.349-.476l.019-.007.004-.002h.001" />
                            </svg>
                            <span v-show="!isExpand"   class="pl-3 text-black font-bold" :class="{'text-white' : active == 'start' as string }">เริ่มต้น</span>
                    </button>
                </router-link>
                <router-link to="/Services" class="relative  ">
                    <button @click="{ show_Chat = false ; updateActiveTap('service') }" 
                        ...
                        class="flex justify-center hover:bg-[#00ABB3] text-white w-full  py-3    ">
                            <svg v-show="!isExpand"  xmlns="http://www.w3.org/2000/svg"  width="24" height="24" fill="currentColor"
                            :style="{ color: active == 'service' as string? activeOpenColor:activecCloseColor }"  
                            class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                                    d="M8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                            </svg><svg v-show="isExpand" xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="currentColor"
                            :style="{ color: active == 'service' as string? activecCloseColor:activeOpenColor }" 
                                class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                                    d="M8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                            </svg>
                            <span v-show="!isExpand"   class="pl-3 text-black font-bold" :class="{'text-white' : active == 'service' as string }">บริการ</span>
                    </button>
                </router-link>
                <router-link to="/Stock" class="relative  ">
                    <button @click="{ show_Chat = false ; updateActiveTap('stock') }" 
                        ...
                        class="flex justify-center hover:bg-[#00ABB3] text-white w-full  py-3    ">
                            <svg v-show="!isExpand"  xmlns="http://www.w3.org/2000/svg"  width="24" height="24" fill="currentColor"
                            :style="{ color: active == 'stock' as string? activeOpenColor:activecCloseColor }"  
                            class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                                    d="M5.929 1.757a.5.5 0 1 0-.858-.514L2.217 6H.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h.623l1.844 6.456A.75.75 0 0 0 3.69 15h8.622a.75.75 0 0 0 .722-.544L14.877 8h.623a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1.717L10.93 1.243a.5.5 0 1 0-.858.514L12.617 6H3.383L5.93 1.757zM4 10a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm4-1a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1z" />
                           </svg><svg v-show="isExpand" xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="currentColor"
                            :style="{ color: active == 'stock' as string? activecCloseColor:activeOpenColor }" 
                                class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path
                                    d="M5.929 1.757a.5.5 0 1 0-.858-.514L2.217 6H.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h.623l1.844 6.456A.75.75 0 0 0 3.69 15h8.622a.75.75 0 0 0 .722-.544L14.877 8h.623a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1.717L10.93 1.243a.5.5 0 1 0-.858.514L12.617 6H3.383L5.93 1.757zM4 10a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm4-1a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1z" />
                           </svg>
                            <span v-show="!isExpand"   class="pl-3 text-black font-bold" :class="{'text-white' : active == 'stock' as string }">คลังสินค้า</span>
                    </button>
                </router-link>
                <router-link to="/Order" class="relative  ">
                    <button @click="{ show_Chat = false ; updateActiveTap('order') }" 
                        ...
                        class="flex justify-center hover:bg-[#00ABB3] text-white w-full  py-3    ">
                            <svg v-show="!isExpand"  xmlns="http://www.w3.org/2000/svg"  width="24" height="24" fill="currentColor"
                            :style="{ color: active == 'order' as string? activeOpenColor:activecCloseColor }"  
                            class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                            </svg><svg v-show="isExpand" xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="currentColor"
                            :style="{ color: active == 'order' as string? activecCloseColor:activeOpenColor }" 
                                class="bi bi-flag-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.004-.001.274-.11a.75.75 0 0 1 .558 0l.274.11.004.001 6.971 2.789Zm-1.374.527L8 5.962 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339Z" />
                            </svg>
                            <span v-show="!isExpand"   class="pl-3 text-black font-bold" :class="{'text-white' : active == 'order' as string }">ออเดอร์</span>
                    </button>
                </router-link>
                ...
                <router-link to="/livechat/facebook" class="relative  ">
                    <button @click="{ show_Chat = false ; updateActiveTap('chat') }" 
                        ...
                        class="flex justify-center hover:bg-[#00ABB3] text-white w-full  py-3    ">
                            ...
                            <span v-show="!isExpand"   class="pl-3 text-black font-bold" :class="{'text-white' : active == 'chat' as string }">แชท</span>
                    </button>
                </router-link>
...
const activeOpenColor = ref('white')
const activecCloseColor = ref('black')

            ...
            <div :class="[isExpand ? '' : 'bg-white']" class="m-2 ">
                ...
                <div :class="[isExpand ? 'justify-center' : 'justify-end py-2 mx-2 ']" class=" flex  ">
                    <button @click="isExpand = !isExpand"
                        :class="[isExpand ? 'justify-center' : 'justify-end bg-[#394867]']"
                        class="flex  space-x-2  w-full px-3 py-2  duration-300  rounded-md  hover:bg-gray-500  ">
                        <svg :class="[isExpand ? 'fill-blue-500  hover:rotate-[360deg] hover:scale-125' : 'fill-white rotate-[180deg] hover:rotate-[540deg] hover:scale-125']"
            ...
            <div class="m-2 justify-center duration-300 " :class="isExpand ? 'mt-20' : 'mt-10 '">
                <router-link to="/Start" class="relative  ">
                    <button @click="{ show_Chat = false; updateActiveTap('start') }"
                        ...
                        <svg v-show="!isExpand" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="currentColor"
                        ...
                        <span v-show="!isExpand" class="pl-3 text-black font-bold"

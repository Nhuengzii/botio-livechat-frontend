<template>
    <aside class="flex-row justify-center bg-indigo-950 h-[96%] w-[18rem] rounded-3xl ml-2 p-4 border transition-all 
        ...
        :class="{'w-[5.8rem]': store.is_expanded}">
        ...
        <div class="w-[12rem] -top-[8rem]">
            <UserProfile/>
            <div class="top-3 px-6 py-4 overflow-y-auto bg-gray-50 rounded-2xl items-center">
                <div class="space-y-2 font-medium ">
                    <router-link to="/" class="flex items-center p-4 text-gray-900 rounded-lg hover:bg-gray-200">
                        <svg class="flex-shrink-0 w-7 h-7 text-gray-900 transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <router-link to="/" class="flex items-center p-4 text-gray-900 rounded-lg hover:bg-gray-200">
                        <svg  class="flex-shrink-0 w-7 h-7 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z"></path>
                        </svg>
                        <span class="ml-3">Services</span>
                    </router-link>
                    <router-link to="/" class="flex items-center p-4 text-gray-900 rounded-lg hover:bg-gray-200">
                        <svg  class="flex-shrink-0 w-7 h-7 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <router-link to="/" class="flex items-center p-4 text-gray-900 rounded-lg hover:bg-gray-200">
                        <svg  class="flex-shrink-0 w-7 h-7 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <path clip-rule="evenodd" fill-rule="evenodd" d="M12.556 17.329l4.183 4.182a3.375 3.375 0 004.773-4.773l-3.306-3.305a6.803 6.803 0 01-1.53.043c-.394-.034-.682-.006-.867.042a.589.589 0 00-.167.063l-3.086 3.748zm3.414-1.36a.75.75 0 011.06 0l1.875 1.876a.75.75 0 11-1.06 1.06L15.97 17.03a.75.75 0 010-1.06z"></path>
                        </svg>
                ...
                <div class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <router-link to="/" class="flex items-center p-3 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-200 ">
                        <svg  class="flex-shrink-0 w-7 h-7 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

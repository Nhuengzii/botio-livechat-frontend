                ...
                <div class="flex flex-col h-full">
                    <div class='grid grid-cols-12 gap-y-2'>
                        <div v-for="item in storeMessage.messages" key="item.messageId" 
                            ...
                            <div :class="{'flex flex-row items-center': item.source.sourceType === 'USER',
                                            'flex items-center justify-start flex-row-reverse': item.source.sourceType === 'ADMIN'
                                        }">
                                <div v-if="item.source.sourceType === 'USER'" class='flex items-center justify-center h-12 w-12 rounded-full bg-indigo-500 flex-shrink-0'>
                                <img :src="item.source.sourcePicture" alt="" class="object-cover h-12 w-12 rounded-full">
                                    </div>
                                <div
                                    :class="{'relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl': item.source.sourceType === 'USER',
